...
public class GuildBanCountMetric extends Metric {
    private static final String NAME = "discord_guild_ban_count";
    private static final String DESCRIPTION = "The number of bans in a Discord guild";
    private static final String HELP = "The number of banned users in a Discord guild";
    private static final String[] LABELS = {"guild_id", "guild_name"};

    private Gauge gauge;

    public GuildBanCountMetric() {
